...
def render_children(parent, menu_items, request):
    """
    Hierarchial menu rendering for django-menuz admin panel.
    """
    childs = []
    output = []
    ...
    if childs:
        ...
        for child in childs:
            ...
            output.append(render_to_string(
                                           'admin/menuz/menuz/menu_item.html',
                                           {'item': child},
        ...
        if menu_items:
            ...
            for menu in menu_items:
                if not menu.parent:
                    ...
                    output.append(render_to_string('admin/menuz/menuz/menu_item.html',
                                                    {'item': menu},
                                                    context_instance=RequestContext(request)))
